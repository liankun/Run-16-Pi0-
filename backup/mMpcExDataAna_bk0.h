...
int mMpcExDataAna::lshower_track_init(){
  ...
  hlshower_bbc[0] = new TH2D("hlshower_bbc_arm0","lshower vs bbc charge arm0",200,-0.5,199.5,200,0,100);
  ...
  hlshower_bbc[1] = new TH2D("hlshower_bbc_arm1","lshower vs bbc charge arm0",200,-0.5,199.5,200,0,100);
...
int mMpcExDataAna::lshower_track_study(){
  ...
  for(unsigned int i = 0;i < NLshowers;i++){
    ...
    for(int itrack = 0;itrack < Ntracks;itrack++){
      ...
      if(Nfired_layers == 6 && (Nfired_layers == Ntrack_hits)){
...
int mMpcExDataAna::Pi0_Mass_init(){
  return EVENT_OK;
}

int mMpcExDataAna::Pi0_Mass_study(PHCompositeNode* topNode){
  return EVENT_OK;
}
